...
// getTodos('assets/dj.json', (err, data) => {
//     console.log(data);
//     getTodos('assets/fnd.json', (err, data) => {
//         console.log(data);
//         getTodos('assets/jude.json', (err, data) => {
//             console.log(data);
//         });
//     });
// });
...
// getTodosP('assets/dj.json').then(data => {
//     console.log(data);
//     return getTodosP('assets/fnd.json');
// }).then(data => {
//     console.log(data);
//     return getTodosP('assets/jude.json');
// }).then(data => {
//     console.log(data);
// }).catch(err => {
//     console.log(err);
...
// fetch API 
// fetch('assets/dj.json').then(response => {
...
const getTodos = async () => {
    const response = await fetch("assets/dj.json");
